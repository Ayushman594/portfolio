This is My portfolio App that I created using HTML, CSS , Bootstrap and React. This app includes Routing to other pages By clicking on links in the Navbar. <br>
